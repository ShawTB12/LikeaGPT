...
=== 分析要求 ===
以下の形式で企業分析レポートを作成してください：

1. 企業概要：会社の基本情報、事業内容、設立背景
2. 市場ポジション：業界での立ち位置、競合状況、市場シェア
3. 主要な課題：現在直面している課題や問題点
4. 解決策・戦略：課題に対する対応策や成長戦略
5. 財務状況：売上、利益、財務健全性の分析
6. 戦略的方向性：中長期的な方針や投資計画
7. リスク分析：事業リスク、市場リスク、規制リスク等
8. 結論と展望：総合評価と将来予測

また、以下のデータも推定して提供してください：
- 主要財務指標（売上高、成長率、市場シェア、従業員数）
- 3つの重要な洞察（アイコン、タイトル、説明）
- チャート用のサンプルデータ（市場シェア推移、財務トレンド、競合比較）

回答は日本語で、具体的で実用的な内容にしてください。
`
